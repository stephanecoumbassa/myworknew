...
function lahb_language( $atts, $uniqid, $once_run_flag ) {
	...
	// render
	$out .= '
	<div class="lahb-element lahb-icon-wrap lahb-language ' . esc_attr( $extra_class ) . ' " id="lahb-language-' . esc_attr( $uniqid ) . '" >';
