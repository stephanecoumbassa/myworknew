...
function lahb_styling_tab_output( $atts = array(), $el = '', $class = '', $class_hover = '' ) {
	...
	$desktop_style .= ! empty( $margin_right_all ) ? 'margin-right:' . LAHB_Helper::css_sanatize( $margin_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $margin_bottom_all ) ? 'margin-bottom:' . LAHB_Helper::css_sanatize( $margin_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $margin_left_all ) ? 'margin-left:' . LAHB_Helper::css_sanatize( $margin_left_all ) . ';' : '' ;

	$desktop_style .= ! empty( $padding_top_all ) ? 'padding-top:' . LAHB_Helper::css_sanatize( $padding_top_all ) . ';' : '' ;
	$desktop_style .= ! empty( $padding_right_all ) ? 'padding-right:' . LAHB_Helper::css_sanatize( $padding_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $padding_bottom_all ) ? 'padding-bottom:' . LAHB_Helper::css_sanatize( $padding_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $padding_left_all ) ? 'padding-left:' . LAHB_Helper::css_sanatize( $padding_left_all ) . ';' : '' ;

	$desktop_style .= ! empty( $top_left_radius_all ) ? 'border-top-left-radius:' . LAHB_Helper::css_sanatize( $top_left_radius_all ) . ';' : '' ;
	$desktop_style .= ! empty( $top_right_radius_all ) ? 'border-top-right-radius:' . LAHB_Helper::css_sanatize( $top_right_radius_all ) . ';' : '' ;
	$desktop_style .= ! empty( $bottom_right_radius_all ) ? 'border-bottom-right-radius:' . LAHB_Helper::css_sanatize( $bottom_right_radius_all ) . ';' : '' ;
	$desktop_style .= ! empty( $bottom_left_radius_all ) ? 'border-bottom-left-radius:' . LAHB_Helper::css_sanatize( $bottom_left_radius_all ) . ';' : '' ;
	...
	$desktop_style .= ! empty( $border_right_all ) ? 'border-right-width:' . LAHB_Helper::css_sanatize( $border_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $border_bottom_all ) ? 'border-bottom-width:' . LAHB_Helper::css_sanatize( $border_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $border_left_all ) ? 'border-left-width:' . LAHB_Helper::css_sanatize( $border_left_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_top_all ) ? 'top:' . LAHB_Helper::css_sanatize( $position_top_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_right_all ) ? 'right:' . LAHB_Helper::css_sanatize( $position_right_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_bottom_all ) ? 'bottom:' . LAHB_Helper::css_sanatize( $position_bottom_all ) . ';' : '' ;
	$desktop_style .= ! empty( $position_left_all ) ? 'left:' . LAHB_Helper::css_sanatize( $position_left_all ) . ';' : '' ;
	...
	$tablet_style .= ! empty( $margin_right_tablets ) ? 'margin-right:' . LAHB_Helper::css_sanatize( $margin_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $margin_bottom_tablets ) ? 'margin-bottom:' . LAHB_Helper::css_sanatize( $margin_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $margin_left_tablets ) ? 'margin-left:' . LAHB_Helper::css_sanatize( $margin_left_tablets ) . ';' : '' ;

	$tablet_style .= ! empty( $padding_top_tablets ) ? 'padding-top:' . LAHB_Helper::css_sanatize( $padding_top_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $padding_right_tablets ) ? 'padding-right:' . LAHB_Helper::css_sanatize( $padding_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $padding_bottom_tablets ) ? 'padding-bottom:' . LAHB_Helper::css_sanatize( $padding_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $padding_left_tablets ) ? 'padding-left:' . LAHB_Helper::css_sanatize( $padding_left_tablets ) . ';' : '' ;

	$tablet_style .= ! empty( $top_left_radius_tablets ) ? 'border-top-left-radius:' . LAHB_Helper::css_sanatize( $top_left_radius_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $top_right_radius_tablets ) ? 'border-top-right-radius:' . LAHB_Helper::css_sanatize( $top_right_radius_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $bottom_right_radius_tablets ) ? 'border-bottom-right-radius:' . LAHB_Helper::css_sanatize( $bottom_right_radius_tablets ) . ';' : '' ;
	...
	$tablet_style .= ! empty( $border_right_tablets ) ? 'border-right-width:' . LAHB_Helper::css_sanatize( $border_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $border_bottom_tablets ) ? 'border-bottom-width:' . LAHB_Helper::css_sanatize( $border_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $border_left_tablets ) ? 'border-left-width:' . LAHB_Helper::css_sanatize( $border_left_tablets ) . ';' : '' ;

	$tablet_style .= ! empty( $position_top_tablets ) ? 'top:' . LAHB_Helper::css_sanatize( $position_top_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $position_right_tablets ) ? 'right:' . LAHB_Helper::css_sanatize( $position_right_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $position_bottom_tablets ) ? 'bottom:' . LAHB_Helper::css_sanatize( $position_bottom_tablets ) . ';' : '' ;
	$tablet_style .= ! empty( $position_left_tablets ) ? 'left:' . LAHB_Helper::css_sanatize( $position_left_tablets ) . ';' : '' ;
	...
	if ( ! empty( $tablet_style ) ) :
		$tablet_styles .= '@media only screen and ( max-width:1024px ) {' . $class . ' { '  . $tablet_style  . '} }';
	endif;

	if ( ! empty( $tablet_style_hover ) ) :
		$tablet_styles .= '@media only screen and ( max-width:1024px ) {' . $class_hover . ':hover { ' . $tablet_style_hover . '} }';
	endif;
	...
	$mobile_style .= ! empty( $margin_right_mobiles ) ? 'margin-right:' . LAHB_Helper::css_sanatize( $margin_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $margin_bottom_mobiles ) ? 'margin-bottom:' . LAHB_Helper::css_sanatize( $margin_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $margin_left_mobiles ) ? 'margin-left:' . LAHB_Helper::css_sanatize( $margin_left_mobiles ) . ';' : '' ;

	$mobile_style .= ! empty( $padding_top_mobiles ) ? 'padding-top:' . LAHB_Helper::css_sanatize( $padding_top_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $padding_right_mobiles ) ? 'padding-right:' . LAHB_Helper::css_sanatize( $padding_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $padding_bottom_mobiles ) ? 'padding-bottom:' . LAHB_Helper::css_sanatize( $padding_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $padding_left_mobiles ) ? 'padding-left:' . LAHB_Helper::css_sanatize( $padding_left_mobiles ) . ';' : '' ;

	$mobile_style .= ! empty( $top_left_radius_mobiles ) ? 'border-top-left-radius:' . LAHB_Helper::css_sanatize( $top_left_radius_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $top_right_radius_mobiles ) ? 'border-top-right-radius:' . LAHB_Helper::css_sanatize( $top_right_radius_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $bottom_right_radius_mobiles ) ? 'border-bottom-right-radius:' . LAHB_Helper::css_sanatize( $bottom_right_radius_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $bottom_left_radius_mobiles ) ? 'border-bottom-left-radius:' . LAHB_Helper::css_sanatize( $bottom_left_radius_mobiles ) . ';' : '' ;
	...
	$mobile_style .= ! empty( $border_right_mobiles ) ? 'border-right-width:' . LAHB_Helper::css_sanatize( $border_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $border_bottom_mobiles ) ? 'border-bottom-width:' . LAHB_Helper::css_sanatize( $border_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $border_left_mobiles ) ? 'border-left-width:' . LAHB_Helper::css_sanatize( $border_left_mobiles ) . ';' : '' ;

	$mobile_style .= ! empty( $position_top_mobiles ) ? 'top:' . LAHB_Helper::css_sanatize( $position_top_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $position_right_mobiles ) ? 'right:' . LAHB_Helper::css_sanatize( $position_right_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $position_bottom_mobiles ) ? 'bottom:' . LAHB_Helper::css_sanatize( $position_bottom_mobiles ) . ';' : '' ;
	$mobile_style .= ! empty( $position_left_mobiles ) ? 'left:' . LAHB_Helper::css_sanatize( $position_left_mobiles ) . ';' : '' ;
