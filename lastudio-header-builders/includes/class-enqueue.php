...
if ( ! class_exists( 'LAHB_Enqueue' ) ) :
    ...
    class LAHB_Enqueue {
        ...
        public function editor_scripts() {
            ...
            if ( LAHB_Helper::is_backend_builder() ) {
                ...
                if(!wp_style_is('font-awesome')){
                    wp_enqueue_style('font-awesome', LAHB_Helper::get_file_uri('assets/src/editor/css/font-awesome.css') , array(), '4.7');
                }
                ...
                wp_enqueue_script( 'lahb-editor-scripts', LAHB_Helper::get_file_uri('assets/src/editor/editor.js' ), array('lahb-nicescroll-script'), LAHB::VERSION, true );
                ...
                // Styles
                wp_enqueue_style( 'lahb-editor-styles', LAHB_Helper::get_file_uri( 'assets/src/editor/css/editor.css' ), array(),LAHB::VERSION );
            }
        ...
        public function dynamic_styles(){
            $header_preset_key = !empty($_GET['prebuild_header']) ? esc_attr($_GET['prebuild_header']) : '';
            $dynamic_styles = apply_filters( 'LAHB/get_dynamic_styles', LAHB_Helper::get_dynamic_styles(LAHB_Helper::is_prebuild_header_exists($header_preset_key) ? $header_preset_key : '') );
            printf('<style id="lahb-frontend-styles-inline-css">%s</style>', $dynamic_styles);
        }
