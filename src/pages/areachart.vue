...
export default {
    ...
    props: {
        series: { type: Array, default () { return [{ name: 'Nbre Dons.', data: [14, 45, 12, 47, 44, 32, 74, 12, 12] }] } },
    ...
    data () {
        return {
            ...
            chartOptions: {
                ...
                xaxis: { categories: [ 'janv', 'fev', 'Mar', 'Avr', 'Mai', 'Jui', 'Jul', 'Aou', 'Sep', 'oct', 'nov', 'dec' ], title: { text: this.title } },
